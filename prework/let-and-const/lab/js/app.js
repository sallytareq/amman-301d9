...
function displayPics(){
  ...
  // 'rando' is not defined, that because it's scope is inside the while-block and not in the function-block, so to the console.log 'rando' is not defined yet.
  // To fix this you can either move the console inside the while-block, give 'rando' global scope or give it the scope of the function-block.
  console.log(viewed);
